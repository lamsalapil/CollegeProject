...
@section('content')
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header text-white bg-primary font-weight-bold">Create Destination</div>
            <form method="POST" action="{{ route('admin.destination.store') }}" accept-charset="UTF-8">
                @csrf
                <div class="card-body">
                    <label>Name</label>
                    <input class="form-control form-control-lg" type="text" name="name" placeholder="Name of destination"> <br/>
